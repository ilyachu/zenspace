...
export const SupportModal: React.FC<SupportModalProps> = ({
  ...
  const t = {
    ru: {
      ...
      donateDesc: 'Поддержите релиз мобильного приложения и запись новых студийных голосовых практик.',
      donateBtn: 'Поддержать релиз (CloudTips)',
      telegramBtn: 'Связаться с автором в Telegram (@chu_il)',
    ...
    en: {
      ...
      donateDesc: 'Support the mobile app release and new studio audio session recordings.',
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-sm bg-[#060c1a]/95 border border-white/10 rounded-3xl p-6 shadow-[0_16px_48px_rgba(0,0,0,0.8)] text-[#e6edf8] flex flex-col gap-4 animate-in zoom-in-95 duration-200"
      ...
      >
        ...
        {/* Description */}
        <p className="text-xs text-[#94a3b8] leading-relaxed font-['Manrope',sans-serif]">
          {t.desc}
        </p>

        {/* Golden Support Card */}
        <div className="p-4 rounded-2xl bg-[#f6c46a]/10 border border-[#f6c46a]/30 shadow-[0_0_20px_rgba(246,196,106,0.08)] flex flex-col gap-2.5">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2.5 px-4 mt-1 rounded-full bg-[#f6c46a] hover:bg-[#ffd78a] text-[#030712] font-bold text-xs tracking-wider uppercase font-['JetBrains_Mono'] transition-all duration-200 shadow-[0_4px_16px_rgba(246,196,106,0.25)] hover:scale-[1.02]"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center justify-center gap-2 p-2.5 rounded-full bg-[#0088cc]/15 hover:bg-[#0088cc]/25 border border-[#0088cc]/35 text-[#38bdf8] text-xs font-medium tracking-wide transition-all duration-200 hover:scale-[1.01]"
        >
